...
namespace RPG.CameraUI
{
    public class CameraRaycaster : MonoBehaviour
    {
        ...
        {
            // Contain raycasts to be only within the game window
            if (currentScreenRect.Contains(Input.mousePosition))
            {
                Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition); //  Form a ray
        ...
        bool RaycastForEnemy(Ray ray)
        {
            ...
            if (enemyHit)
            {
                ...
                onMouseOverEnemy(enemyHit);  // This is the broadcaster
                return true;
            }
            return false;
        }
        ...
        bool RaycastForPotentiallyWalkable(Ray ray)
        {
            ...
            if (potentiallyWalkableHit)
            {
                ...
                onMouseOverPotentiallyWalkable(hitInfo.point);  // This is the broadcaster
                return true;
            }
            return false;
        }
